...
sudo expect /root/public/sh/five.sh && echo "第5步完成!"
...
sudo expect /root/public/sh/nine.sh && echo "第9步完成!"

cd /root/.shardeum && echo "第10步完成!"

sudo expect /root/public/sh/eleven.sh && echo "第11步完成!" && echo "全部步骤结束，开始进行登陆并质押!"
